                ...
                children: [
                  Expanded(
                    child: Text(
                        ...
                        style: TextStyle(color: Colors.white, fontWeight: isRead?FontWeight.normal:FontWeight.bold),
                        overflow:TextOverflow.ellipsis,
                        maxLines: 2,),
                  ),
                  Container(
                  ...
                  isRead?Icon(Icons.check,color:Colors.white):Icon(Icons.notifications,color:Colors.white)
                ],
              )
            ],
          ))
